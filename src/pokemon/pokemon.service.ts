...
export class PokemonService {
  ...
  private defaultLimit: number;  //Defino esta propiedad/dependencia
  ...
  constructor(
    ...
    //console.log(process.env.DEFAULT_LIMIT); //Devuelve indefinido
    //console.log(configService.get('defaultLimit'));  //Devuelve 7 a través del configurationService
